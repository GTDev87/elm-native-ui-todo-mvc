...
var _ohanhi$elm_native_ui$NativeUi$style = function (_p0) {
	return _ohanhi$elm_native_ui$Native_NativeUi.style(
		_ohanhi$elm_native_ui$NativeUi_Style$encode(_p0));
};
...
var _ohanhi$elm_native_ui$NativeUi_Elements$mapView = _ohanhi$elm_native_ui$NativeUi$node('MapView');
...
var _ohanhi$elm_native_ui$Main$model = 900;
